"""Replace rows from multiple CSV/TSV files using a composite key.
...
Usage::
    ...
    python -m src.replace_rows out.tsv in1.tsv in2.tsv in3.tsv --key-col id
    python -m src.replace_rows out.csv base.csv patch.csv --key-col gene,variant
"""
...
def replace_rows(
    ...
    """Replace rows from *input_files* and write to *output_file*.
